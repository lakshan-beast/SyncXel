...
export default function Documentation() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 py-0 mt-2 lg:mt-12 px-4 lg:px-5 mb-5 max-w-7xl w-full mx-auto font-baloo relative overflow-x-hidden">
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mt-0">
          ...
          <aside className="lg:col-span-1 space-y-1 ">
            <div className="bg-white border border-slate-200 rounded-3xl p-3 flex lg:flex-col gap-1.5 shadow-xs scrollbar-thumb-slate-300 overflow-x-scroll">
