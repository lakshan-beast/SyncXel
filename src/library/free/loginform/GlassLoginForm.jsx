...
const GlassLoginForm = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-full w-full p-2 overflow-hidden rounded-2xl bg-cover bg-center border-none border-slate-800">
      {/* Background Glows */}
