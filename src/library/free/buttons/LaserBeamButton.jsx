...
export default function LaserBeamButton() {
  return (
    <div className="relative p-[1px] rounded-xl overflow-hidden inline-block group cursor-pointer">
      ...
      />
      <button className="relative px-5 py-2 bg-slate-950 text-cyan-400 hover:text-cyan-300 text-xs font-mono rounded-[11px] transition-colors cursor-pointer w-full h-full">
        // Laser Beam
      </button>
    </div>
  );
