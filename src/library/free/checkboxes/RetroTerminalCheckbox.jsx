...
export default function RetroTerminalCheckbox() {
  ...
  return (
    <div
      ...
      <div
        ...
        {checked && (
          <span className="text-green-400 text-[10px] font-bold">X</span>
        )}
      </div>
      <span className="text-xs text-green-400">SYS_CHECK_BOX</span>
    </div>
  );
}
