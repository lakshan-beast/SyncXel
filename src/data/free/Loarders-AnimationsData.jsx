...
export const loadersData = [
  {
    ...
    category: "Loaders & Animations",
    description:
      "A clean, minimalist spinning ring loader powered by Framer Motion and vibrant cyan accent.",
    copiesCount: 142,
    component: <CyanRingLoader />,
    code: `<motion.div animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 1, ease: "linear" }} className="w-6 h-6 border-2 border-cyan-500 border-t-transparent rounded-full shadow-[0_0_10px_rgba(34,211,238,0.3)]" />`,
  },
  {
    id: "loader-emerald-text",
    title: "Emerald Spinner with Text",
