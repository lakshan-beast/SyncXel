...
export default function TechStack() {
  ...
  return (
    <section className="py-12 overflow-hidden relative border-none">
      {/* Animation Styles for Marquee */}
      <style>
        {`
          @keyframes marquee {
      ...
      <motion.div
        ...
        <div className="relative w-full overflow-hidden py-5 bg-slate-50/60 border-none border-slate-200/80 rounded-xl">
          {/* Left Gradient Fade */}
