...
export default function DocsPreviewSection() {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
      <div className="bg-slate-900/40 border border-white/10 rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-2xl">
        {/* Header */}
        ...
        <div className="text-center">
          <Link
            to="/docs"
            className="inline-flex items-center space-x-2 px-6 py-3 bg-cyan-500 text-slate-950 font-bold text-sm rounded-xl hover:bg-cyan-400 transition-all shadow-lg shadow-cyan-500/20">
