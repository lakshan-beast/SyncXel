    ...
    <div className="font-mono">
      ...
      <div className="fixed bottom-4 left-4 z-40 md:hidden">
        <motion.button
          ...
          className="px-5 py-5 bg-amber-300 backdrop-blur-md border border-slate-700 rounded-4xl text-xs font-bold font-baloo text-slate-200 flex items-center space-x-1 shadow-2xl cursor-pointer">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-2 gap-y-8 lg:gap-x-7 lg:gap-y-10 px-2 md:px-0">
              ...
              <div className="flex items-center justify-between px-2 py-2 bg-white border-b-2 border-slate-200">
                <div className="flex items-center bg-slate-300/50 p-0 rounded-lg border border-slate-100">
                  <button
                    ...
                    className={`text-xs px-2 py-1.5 rounded-lg font-baloo font-medium transition-all flex items-center space-x-2 cursor-pointer ${
                      currentTab === "preview"
