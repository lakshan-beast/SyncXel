export default function SystemStatus() {
  return (
    <div className="fixed bottom-4 right-23 z-50 bg-black/80 backdrop-blur-md border-2 border-cyan-500/30 rounded-full p-3 text-xs text-cyan-400 font-baloo shadow-[0_0_15px_rgba(34,211,238,0.15)] flex items-center space-x-2 px-6 py-3">
      ...
      <div className="relative flex items-center justify-center h-8 w-8">
        {/* Outer Rotating Ring */}
        <span
          className="absolute inset-0 rounded-full border-2 border-dashed border-cyan-400 animate-spin opacity-75"
