import CyberAccordionPreview from "./CyberAccordionPreview";
import MatrixLogAccordion from "./MatrixLogAccordion";
...
export const accordionsData = [
  {
    ...
    description:
      "Interactive collapsible system protocol log featuring smooth framer-motion height scaling.",
    copiesCount: 285,
  ...
  },
  {
    ...
    category: "Accordions & Collapsibles",
    description:
      "Terminal diagnostic expander optimized for compact container preview cards.",
    copiesCount: 240,
